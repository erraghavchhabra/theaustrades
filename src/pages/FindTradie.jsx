  ...
  return (
    <section>
      <div className="container py-5">
        {/* Header Section */}
        <div className="bg-info bg-opacity-10 p-4 rounded mb-5">
          ...
          <div className="row">
            <div className="col-md-7">
              <ul className="mb-0">
                <li>
                  Don’t do the ring around. Tradespeople who are keen to work
                  WILL CONTACT YOU!
                </li>
                <li>Get up to 3 quotes then you choose the best one.</li>
                <li>There is 100% no obligation to hire.</li>
                <li>
                  Backed by Australia’s largest home services directory. We have
                  over 39,000 tradesmen on site.
                </li>
                <li>Call us anytime on 1300 192 161 (7 days a week)</li>
              </ul>
            </div>
            <div className="col-md-5 mt-4 mt-md-0">
              <div className="p-3 rounded border shadow-sm bg-light h-100 d-flex flex-column justify-content-between">
                <p>
        ...
        <form className="row g-3">
          ...
          <div className="col-12">
            <label className="form-label">Describe what you need done?</label>
            <textarea
              className="form-control"
              rows={3}
          ...
          <div className="col-12">
            <label className="form-label">Best number to contact you on</label>
